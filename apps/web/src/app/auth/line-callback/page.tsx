  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="text-center space-y-4">
        <div className="w-16 h-16 bg-[#00B900] rounded-full flex items-center justify-center mx-auto">
        ...
        <div className="space-y-1">
          <p className="text-lg font-medium">เข้าสู่ระบบสำเร็จ</p>
          <p className="text-muted-foreground text-sm leading-relaxed">
            กำลังกลับไป... <span className="tabular-nums font-mono text-foreground">{count}</span>
          </p>
        </div>
      </div>
    </div>
