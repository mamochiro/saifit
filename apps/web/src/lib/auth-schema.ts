...
// Better Auth tables — separate from the app's "users" table.
// JS property names must match better-auth's camelCase field names.
// SQL column names use snake_case (pg convention).
